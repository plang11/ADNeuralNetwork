...
# Remaining Tasks
- Add workflow figure
- Add objective description to beginning of this file
- Add data dictionary in this file
- Clinical definition/diagnosis criteria for AD
- Info on origin of dataset
- Code for Figures and Tables to submit
- Number the code file

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

# AD Regression Neural Network in Base R
...
This tutorial aims to show the building blocks of a neural network from scratch. In this code file, you will build a series of helper functions that will then be combined to build a two layer neural network to predict the ADAS-COG 11 value at 12 months given a series of baseline features. 
...
https://pubmed.ncbi.nlm.nih.gov/6610841/
...
## Data Dictionary of train_clean.csv

AGE
-Age in Years at Baseline (standardized)

SEX
-Patient Sex (0 = Female, 1 = Male)

RACE
-Patient Race (0 = White, 1 = Non-white)

ETHNIC
-Patient Ethnicity (0 = Non Hispanic or Latino, 1 = Hispanic or Latino)

AD
-Alzheimer's Disease Diagnosis

MILDAD
-Mild Alzheimer's Disease Diagnosis

MCI
-Mild Cognitive Impairment Diagnosis

baseline
-ADAS-COG 11 Score at Baseline (standardized)

month12
-ADAS-COG 11 Score at 12 months +/- 45 days

perc_change
-Percent Change in ADAS-COG 11 score from baseline to 12 months

improved
-Improvement (reduction) in ADAS-COG 11 score from baseline to 12 months

declined
-Decline (increase) in ADAS-COG 11 score from baseline to 12 months
...
predict <- function(X, y, parameters) {
  ...
  for(i in 1:ncol(X)) {
    ...
    A1 <- linear_activation_fwd(patient, xxx, xxx, activation = "relu")
    A2 <- linear_activation_fwd(A1[["A"]], xxx, xxx, activation = "sigmoid")
...
#template code for figures to generate after model run

#Current tables
##Table of n_layers, size of layers, loss function value
